                    ...
                    <>
                        ...
                        <div className='flex flex-col h-screen w-full max-w-4xl mx-auto'>
                            <div className='lg:flex lg:flex-col lg:w-5xl'>
                                <div className='flex flex-col px-5 items-center lg:flex-row lg:gap-8 lg:w-5xl lg:p-0 mb-5'>
                                    ...
                                    <div className='lg:min-w-[400px]'>
                                        <div className='flex flex-col items-center sm:justify-between md:flex-col md:justify-between gap-5 max-w-[550px] '>
                                            <h3 className='font-bold text-2xl mb-3'>{toy?.title}</h3>
                                ...
                                <div className='flex flex-row w-full mb-10 gap-3 justify-center'>
                                    <button className='px-5 py-3 w-full max-w-[200px] whitespace-nowrap bg-orange-500/50 font-semibold rounded-xl hover:bg-orange-500/70' onClick={() => {
                                        handleCartBtn()
                                        navigate("/cart")
                                    }}>Купить</button>
